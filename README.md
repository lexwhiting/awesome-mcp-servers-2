...
- <img src="https://settlegrid.ai/favicon.ico" height="14"/> [SettleGrid](https://settlegrid.ai) - Per-call billing and monetization for MCP servers. Add usage metering, API key validation, and Stripe
   payouts with 2 lines of code. Supports 6 pricing models and 10 payment protocols. Free tier: 25K ops/month.
